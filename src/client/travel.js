...
buttons.forEach(button => {
    button.addEventListener('click', async (e) => {
        ...
        document.body.innerHTML = `
            ...
            <p>This exhibit was created to help promote UWE's Climate and Sustainability Plan. In particular, it represents UWE's commitment to reducing biodiversity loss.</p>
            ...
            <p>Look to the timelapse on the wall: you may notice the wonderful environment degrading before your eyes, but, with a little effort, it can be restored to its former glory.</p>
